          ...
          <div className="row">
            <div className="col-lg-4 col-md-6 mb-4">
              <div className="box bg-white border p-3 rounded-3">
                <Link to="/blogPage/0" className="text-decoration-none">
                  <img
            ...
            <div className="col-lg-4 col-md-6 mb-4">
              <div className="box bg-white border p-3 rounded-3">
                <a href="/blogPage/1" className="text-decoration-none">
                  <img
            ...
            <div className="col-lg-4 col-md-6 mb-4">
              <div className="box bg-white border p-3 rounded-3">
                <a href="/blogPage/2" className="text-decoration-none">
                  <img
            ...
            <div className="col-lg-4 col-md-6 mb-4">
              <div className="box bg-white border p-3 rounded-3">
                <a href="/blogPage/3" className="text-decoration-none">
                  <img
